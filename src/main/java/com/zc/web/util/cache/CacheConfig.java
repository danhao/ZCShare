...
public class CacheConfig {
	...
	public CacheConfig(String name, int size, int timeout, int recycleRate, String recycleHandler,
			boolean recycleByAccess, int checkInterval) {
		this.name = name;
		this.size = size;
	...
	public CacheConfig(String name, int size, int timeout, int recycleRate, String recycleHandler,
			boolean recycleByAccess, int checkInterval, boolean forceClean) {
		this.name = name;
		this.size = size;
		this.timeout = timeout;
		this.recycleRate = recycleRate;
