...
public class Debt extends BaseModel{
	...
	public DebtMsg build(boolean hide) throws SmallException{
		...
		for(Bidder bidder : bidders){
			com.zc.web.message.debt.DebtMsgProto.DebtMsg.Bidder.Builder bb = com.zc.web.message.debt.DebtMsgProto.DebtMsg.Bidder.newBuilder();
			PropUtil.copyProperties(bb, bidder, com.zc.web.message.debt.DebtMsgProto.DebtMsg.Bidder.getDescriptor());
			builder.addBidders(0, bb);
		}

		for(Message message : messages){
			com.zc.web.message.debt.DebtMsgProto.DebtMsg.Message.Builder bb = com.zc.web.message.debt.DebtMsgProto.DebtMsg.Message.newBuilder();
			PropUtil.copyProperties(bb, message, com.zc.web.message.debt.DebtMsgProto.DebtMsg.Message.getDescriptor());
		...
		if(this.type == Constant.TYPE_DEPUTY && (this.state == Constant.STATE_DEALED || this.state == Constant.STATE_CLOSED)){
			FileMsg.Builder fb = FileMsg.newBuilder();
